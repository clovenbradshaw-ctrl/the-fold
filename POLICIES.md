...
absent.
## P25 — A finding is only novel if it differs from what the answerer was already given, never just from the material
...
## P26 — A number is grounded by the company it keeps, not by its digits appearing somewhere in the document
