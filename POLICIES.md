...
## P70 — The generality gate: a specimen-shaped fix and a universal capability read identically until measured apart
...
**The tag.** Every POLICIES.md entry from P70 onward, and every
...
headers for N ≥ 70 and fails if any entry lacks the tag; the matching case
