...
function mergeRelatingLedger(left, nominations) {
  ...
  return [...byProp.entries()]
    ...
    if (req.method === "POST" && p === "/api/term-record") {
      ...
      const CHAT_MIRRORED = new Set(["source-open", "fold-open", "transcribe", "corroborate", "derive", "declare", "concede", "void-concede", "ranke", "obligation-admit", "obligation-mark", "longform-part", "longform-done", "web-digest", "codepiece-plan", "codepiece-part", "codepiece-done", "codepiece-sent-to-chat", "piece-export-built"]);
