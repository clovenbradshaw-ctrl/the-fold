...
// Listeners on the record's own append (GFP Pass 33: the keyless memory —
// the holograph / shadow / echo — is admitted from every line written here —
// field-store.js). A listener is told what was written, after it was written;
// it cannot change it. THE_SHADOW and THE_ECHO are the wordless tiers — state
// + address, no words — for lines worth only remembering that we met.
